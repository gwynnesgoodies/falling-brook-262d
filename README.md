...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/falling-brook-262d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/falling-brook-262d
```

A live public deployment of this template is available at [https://falling-brook-262d.templates.workers.dev](https://falling-brook-262d.templates.workers.dev)
